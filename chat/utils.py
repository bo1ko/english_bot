...
def edit_sync_telegram_message(chat_id, message_id, new_text):
    try:
        telebot_bot.edit_message_text(chat_id=chat_id, message_id=message_id, text=new_text, parse_mode='HTML')
...
def reply_sync_telegram_message(chat_id, message_id, reply_text):
    try:
        telebot_bot.send_message(chat_id, reply_text, reply_to_message_id=message_id, parse_mode='HTML')
...
async def send_async_telegram_message(chat_id: int, text: str):
    ...
    try:
        sent_message = await aiogram_bot.send_message(chat_id=chat_id, text=text, parse_mode=ParseMode.HTML)
